...
각 날짜의 **이 날짜 본문 복사** 버튼을 연 뒤 말씀 상자의 복사 아이콘을 누르면 해당
날짜의 말씀 전체를 복사할 수 있습니다. 여러 날짜를 추출했을 때는 **전체 본문
복사**에서 성공한 모든 날짜를 한 번에 복사할 수 있습니다. 복사되는 내용은
날짜·독서 제목·성경 본문을 TXT와 같은 순서로 유지합니다.
